...
@objc public protocol CollectionViewWaterfallLayoutDelegate:UICollectionViewDelegate {
    ...
    optional func extenalHeightForCollectionView(collectionView: UICollectionView, indexPath: NSIndexPath, calculateSize:CGSize)->Float
        ...
        for section in 0..<numberOfSections! {
            ...
            */
            ...
            for idx in 0..<itemCount {
                ...
                let extenalHeight = self.delegate?.extenalHeightForCollectionView?(collectionView!, indexPath:indexPath, calculateSize:CGSizeMake(CGFloat(itemWidth), CGFloat(itemHeight))) ?? 0
                itemHeight = itemHeight + extenalHeight
